...
bool C_INIT_BD::Creation_BD()
{
    ...
    if(db.isValid())
    {
        ...
        b_test=query.exec("INSERT INTO TPatient "
                          "SELECT '1' AS 'Id', 'Ricardo' AS 'Nom', 'Jacques' AS 'Prenom', '3 rue des justices' AS 'Adresse', 'Tours' AS 'Ville', '37200' AS 'CP', 'Dépressif' AS 'Commentaire', '247558963' AS 'Commentaire', '2017-06-01' AS 'DateConsultation', '90' AS 'DureeConsultation', '2' AS 'Priorite'"
                                  "UNION SELECT 2, 'Pirouette', 'Stephanie', '15 rue des dames', 'Chanceaux', 37390, 'Rien à dire.', 247542942, '2013-06-01', 50, 2 "
                                  "UNION SELECT 3, 'Puisser', 'Albert', '15 rue des chevaux', 'Verigne', 37250, 'Asthmatique.', 247642892, '2013-06-01', 45, 3 "
                                  "UNION SELECT 4, 'Tujais', 'Teo', '15 rue de l''arbre', 'Monts', 37450, '', 247845889, '2013-06-01', 20, 4 "
        ...
        b_test=query.exec("INSERT INTO TRessource "
                          "SELECT '1' AS 'Id', 'Admin' AS 'Nom', 'Admin' AS 'Prenom', '7' AS 'IdType'"
                                  ...
                                  "UNION SELECT 5, 'Boulanger', 'Stephane', 3 "
                                  "UNION SELECT 6, 'Bijet', 'Paul', 3 "
                                  "UNION SELECT 7, 'durant', 'Melanie', 4 "
